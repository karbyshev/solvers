...
(* Solve 1 *)
- idtac.
  intros x d1 s s1 Hnstaxs s0 Heval Ieval Hncalx s2 Hsol.
  red in Ieval.
...
(* Solve 2 *)
- idtac.
  intros x d1 s s1 Hnstaxs s0 Heval Ieval Hcalx.
...
(* Solve1 *)
- idtac.
  intros x d s s1 Hxnsta s0 Hevalrhs Hevalrhssim Hncalxs1.
  red. intros s' Hsims.
...
(* Solve2 *)
- idtac.
  intros x d s s1 Hxnsta s0 Hevalrhs Hevalrhssim Hcalxs1 s2 cur Hleq.
  red. intros s' Hsims.
  assert (Hxnsta' : ~ SI.is_stable x s')
    by (contradict Hxnsta; now eapply sim_is_stable; eauto).
  red in Hevalrhssim.
...
(* Solve3 *)
- idtac.
  intros x d s s1 s4 s5 w Hxnsta s0 Hevalrhs Hevalrhssim Hcalxs1 s2 cur Hleq new s3 Hw Hsolall Hsolallsim.
  red. intros s' Hsims.
  assert (Hxnsta' : ~ SI.is_stable x s')
    by (contradict Hxnsta; now eapply sim_is_stable; eauto).
  red in Hevalrhssim.
